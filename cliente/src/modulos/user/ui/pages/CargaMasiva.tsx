    ...
    <div style={{ minHeight: '100vh', background: '#f8f7f4', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e8e5e0' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '2rem 1.5rem 1.75rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
            ...
            <h1 style={{ margin: 0, fontSize: 22, fontWeight: 600, color: '#1a1a1a', letterSpacing: '-0.3px' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '2rem 1.5rem' }}>
          ...
          {enviando ? (
            <div>
              <div style={{
                ...
                border: '3px solid #e8e5e0', borderTopColor: '#1a1a1a',
                margin: '0 auto 1rem',
                animation: 'spin 0.8s linear infinite',
              }} />
              <p style={{ margin: 0, fontSize: 15, fontWeight: 500, color: '#1a1a1a' }}>Procesando archivo…</p>
              <p style={{ margin: '4px 0 0', fontSize: 13, color: '#aaa' }}>{archivoSeleccionado}</p>
            </div>
          ) : (
            <div>
              <div style={{
        ...
        <div style={{
          ...
          border: '1px solid #e8e5e0', marginBottom: 20, overflow: 'hidden',
        }}>
          <div style={{
            ...
            <span style={{ fontSize: 12, fontWeight: 600, color: '#888', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
              Formato requerido
            </span>
          </div>
            ...
            {[
              ...
              <div key={fila.columna} style={{
                ...
                <span style={{
                  ...
                  color: '#1a1a1a', background: '#f3f2ef', padding: '3px 8px',
        ...
        {errorGlobal && (
          <div style={{
            background: '#fff8f8', border: '1px solid #fcd0d0',
            borderRadius: 12, padding: '14px 18px',
            display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 20,
          }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#e24b4a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginTop: 1, flexShrink: 0 }}>
              <circle cx="12" cy="12" r="10"/>
              <line x1="12" y1="8" x2="12" y2="12"/>
              <line x1="12" y1="16" x2="12.01" y2="16"/>
            </svg>
          ...
          <div style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
              <div style={{
                ...
                <p style={{ margin: '0 0 4px', fontSize: 36, fontWeight: 700, color: '#1e7e45', lineHeight: 1 }}>
                  {resultado.exitosos}
                </p>
              ...
              <div style={{
                ...
                <p style={{
                  margin: '0 0 4px', fontSize: 36, fontWeight: 700, lineHeight: 1,
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
                  <thead>
                    <tr style={{ background: '#fafaf8' }}>
                      <th style={{ padding: '10px 20px', textAlign: 'left', fontWeight: 600, color: '#666', fontSize: 12, width: 80 }}>Fila</th>
                      <th style={{ padding: '10px 20px', textAlign: 'left', fontWeight: 600, color: '#666', fontSize: 12 }}>Motivo</th>
                    </tr>
                  </thead>
                  <tbody>
                    {resultado.errores.map((error: ErrorFila, i: number) => (
                      <tr key={error.fila} style={{ borderTop: '1px solid #f5f3ef' }}>
                        <td style={{ padding: '11px 20px', color: '#999', fontFamily: 'monospace', fontSize: 13 }}>
                          #{error.fila}
                        </td>
                        <td style={{ padding: '11px 20px', color: '#c0392b' }}>
                          {error.motivo}
                        </td>
                      </tr>
                    ))}
